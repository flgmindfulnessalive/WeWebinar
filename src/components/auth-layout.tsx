...
// Shared shell for every "one card, one step" auth screen -- login, signup,
// and onboarding (create your host account right after confirming email).
// Was duplicated verbatim across all three page.tsx files; onboarding's
// copy had drifted into a plain centered card with no branding at all,
// which is what made it look like an unstyled placeholder next to the
// other two. Centralizing it means the three screens can't drift apart
// again.
